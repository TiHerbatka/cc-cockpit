...
- [ ] A9. [TOP PRIORITY 2/3] Rework docs/reference/ (superpowers-era) into the new docs/ structure (features/mechanisms/options/overview), adjusted to the new documentation conventions; update CLAUDE.md + code pointers; remove docs/reference/.
