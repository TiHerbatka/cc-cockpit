...
| GUI glossary & visual map (`GUI-`) | [`docs/gui-map.md`](docs/gui-map.md) + [`docs/gui-map/map.html`](docs/gui-map/map.html) |
...
- **GUI glossary/mapping skill (I2/A10):** built — auto-discovered map at [`docs/gui-map.md`](docs/gui-map.md) (+ `docs/gui-map/map.html`), regenerated by the `/gui-map` skill.
